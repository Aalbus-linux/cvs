...
ACLOCAL = ${SHELL} /usr/src/cvs-1.12.13/build-aux/missing --run aclocal-1.9
ALLOCA = 
ALLOCA_H = 
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /usr/src/cvs-1.12.13/build-aux/missing --run tar
AUTOCONF = ${SHELL} /usr/src/cvs-1.12.13/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /usr/src/cvs-1.12.13/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /usr/src/cvs-1.12.13/build-aux/missing --run automake-1.9
AWK = awk
CC = clang
CCDEPMODE = depmode=gcc3
CFLAGS = -flto=thin -march=native -O2 -pipe -DGNU_SOURCE
CPP = clang -E
...
INTLLIBS = -L/usr/pkg/lib -lintl
INTL_MACOSX_LIBS = 
KRB4 = /usr/kerberos
LDFLAGS = -fuse-ld=lld -rtlib=compiler-rt -unwindlib=libunwind -Wl,-O2 -Wl,--as-needed -Lno/lib
LIBICONV = 
LIBINTL = -L/usr/pkg/lib -lintl
LIBOBJS =  save-cwd$U.o mktime$U.o strftime$U.o canon-host$U.o canonicalize$U.o chdir-long$U.o closeout$U.o dirname$U.o exitfail$U.o filenamecat$U.o getcwd$U.o getdate$U.o getndelim2$U.o getopt$U.o getopt1$U.o getpass$U.o gettime$U.o glob$U.o mbchar$U.o md5$U.o pagealign_alloc$U.o quotearg$U.o regex$U.o strcasecmp$U.o strstr$U.o dup-safer$U.o fd-safer$U.o pipe-safer$U.o xmalloc$U.o xgetcwd$U.o yesno$U.o
LIBS = 
LIB_CLOCK_GETTIME = 
LIB_NANOSLEEP = 
LN_S = ln -s
...
LTLIBOBJS =  save-cwd$U.lo mktime$U.lo strftime$U.lo canon-host$U.lo canonicalize$U.lo chdir-long$U.lo closeout$U.lo dirname$U.lo exitfail$U.lo filenamecat$U.lo getcwd$U.lo getdate$U.lo getndelim2$U.lo getopt$U.lo getopt1$U.lo getpass$U.lo gettime$U.lo glob$U.lo mbchar$U.lo md5$U.lo pagealign_alloc$U.lo quotearg$U.lo regex$U.lo strcasecmp$U.lo strstr$U.lo dup-safer$U.lo fd-safer$U.lo pipe-safer$U.lo xmalloc$U.lo xgetcwd$U.lo yesno$U.lo
MAINT = #
MAINTAINER_MODE_FALSE = 
MAINTAINER_MODE_TRUE = #
MAKEINFO = ${SHELL} /usr/src/cvs-1.12.13/build-aux/missing --run makeinfo
...
POSUB = po
PR = /bin/pr
PS2PDF = /usr/src/cvs-1.12.13/build-aux/missing ps2pdf
RANLIB = llvm-ranlib
ROFF = /usr/bin/groff
RSH_DFLT = rsh
SENDMAIL = no
...
STDINT_H = 
STRIP = 
TEXI2DVI = /usr/src/cvs-1.12.13/build-aux/missing texi2dvi
USE_NLS = yes
VERSION = 1.12.13
XGETTEXT = /usr/bin/xgettext
YACC = ${SHELL} /usr/src/cvs-1.12.13/build-aux/bison-missing --run bison -y
YFLAGS = 
...
infodir = ${prefix}/info
install_sh = /usr/src/cvs-1.12.13/build-aux/install-sh
